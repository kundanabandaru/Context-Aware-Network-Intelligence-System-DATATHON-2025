...
Core Deliverables
1. Predictive Model: LSTM Sequence-to-Sequence for congestion forecasting (Mb/s).
2. Inference Model: STL Decomposition combined with Isolation Forest for anomaly identification and classification (DDoS vs. Massive Download).
3. Contextual Integration: Quantification of the relationship between network activity and Academic Schedule seasonality.
...
Prerequisites
* Python 3.8+
* The raw network data file (tstat_data1.xlsx or tstat_data.csv).
Installation
